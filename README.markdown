...
Projeto simples de uma aplicação de Issue Tracker com `JSF 2.x`,`Primefaces 3.3`, `CDI(Open Web Bean 1.1.4)`, `CODI(1.0.5)` e `Hibernate 4.1.4` com o objetivo de explanar as principais features de cada tecnologia e como integra-las de maneira produtiva em um projeto real. 
